...
def run_experiment(X, Y, save_path, ad, NMF=True, batched=True):
    ...
    csv_file_path = path.join(save_path, 'nsf_validation.csv')
    ...
    for params in ParameterGrid(param_grid):
        ...
        if NMF:
            ...
            factors_path = path.join(nmf_save_path, f"3000/nmf_factors_iter=1000_rs=256_L={kwargs['L']}.npy")
            loadings_path = path.join(nmf_save_path, f"3000/nmf_loadings_iter=1000_rs=256_L={kwargs['L']}.npy")
        ...
        with open(csv_file_path, mode='a', newline='') as file:
            ...
            writer.writerow([kwargs['L'], kwargs['M'], kwargs['sigma'], kwargs['lengthscale'], rmse, poi])
...
def main():
    ...
    save_path = path.join(SPATH, 'nsf/3000')
